...
const Portfolio = () => {
  return (
    <div className="bgimg">
      <nav>
        <ul>
          <li><a href="#home" className="logo">Jerusha.</a></li>
      ...
      <div id="home" className="main">
        <div className="text">
          <h2>HEY THERE!</h2>
          <h1 style={{ margin: '5px' }}>I am <span className="Special">M.Jerusha</span></h1>
          <pre style={{ fontFamily: 'Times New Roman, Times, serif' }}>But you can call me --<span className="Special"><b> Jerush
            </b></span></pre>
          <p><b>I'm currently a student at Annmacharaya institution.</b></p>
          <br /><a href="JERUSH.docx" download>Download CV</a>
        </div>
        <div className="textcol">
          <img src="jerush.jpg" alt="jerusha"/>
        </div>
      </div>
      <section id="aboutme" className="aboutme">
        <h1>About Me</h1>
        <p style={{ textAlign: 'justify' }}>I'm Murathoti Jerusha pursuing Bachelor of Technology in <span className="special">Annmacharaya institution of technology and sciences</span> in the stream of <span className="Special">&nbsp;Electronics and Communiction Engineering.</span> I am passionate about knowing</p>
        ...
        <div className="time">
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I Completed my School Education at Gurukul vidya peeth School, Kadapa</p>
              <p>I got 9.7 CGPA in my School Education.</p>
              <span className="lef-arr"></span>
            </div>
          </div>
          <div className="con rig">
            <img src="apms.jpg" alt="Diploma Education" />
            <div className="text-box">
              <h2><span className="special">Diploma in ECE </span></h2>
              <small>2019-2022</small>
              <p>I Completed my Diploma Education at Govt.Polytechnic college for women, Kadapa.</p>
              <p>I got 8.7 CGPA in my Diploma Education.</p>
          ...
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I got 9.35 CGPA in my Bachelor's Education.</p>
              <span className="lef-arr"></span>
            </div>
          </div>
        </div>
        ...
        <address>
          <div className="add">
            <div className="contact">
              ...
              <p>Address: 1/81,<br /> Vontimitta(M),<br />  Kadapa(D),<br /> Andhra Pradesh state.</p>
            </div>
            <div className="contact">
              <h2><span className="special">Contact me</span></h2><hr />
              <p><b>Email:</b> <a href="jerushabeaula.desu@gmail.com">jerushabeaula@gmail.com</a></p>
              <p><b>Phone:</b> <a href="tel:+91 6304185795">6304185795</a></p>
            </div>
          </div>
